...
import { deleteEvaluation, removeResult } from "@/services/evaluationService";
...
export default {
  ...
  methods: {
    async getEvaluations() {
      ...
      try {
        this.evaluations = await this.$api.evaluation.get(this.session_id);
    ...
    async create() {
      ...
      try {
        let evaluation_id = await this.$api.evaluation.add({
